...
//TODO this class is used to handle step events. Not reccomended to change anything here except for the STEP_THRESHOLD variable


public class StepDetector {
    //This is the class that detects steps from the accelerometer
    private static final int ACCEL_RING_SIZE = 50;
    private static final int VEL_RING_SIZE = 10;

    // change this threshold according to your sensitivity preferences
    public static float STEP_THRESHOLD = 20f;
