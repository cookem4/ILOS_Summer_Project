...
public class OpenCVStepCounter extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    void saveData(){
        ...
        //TODO magCoords is smaller than the other two
        for(int i = 0; i < magTimeStamps.size();i++){
            //0th index is x position 1st index is y position
        ...
        for(int i = 0; i < accelTimeStamp.size();i++){
            //0th index is x position 1st index is y position
        ...
        for(int i = 0; i < gyroTimeStamp.size();i++){
            //0th index is x position 1st index is y position
    ...
    void processScanCoordinates(List<Long> scanTimeStampList, String scanType){
        ...
        System.out.println("LENGTH BEFOREEEE" + scanTimeStampList.size());
        ...
        System.out.println("LENGTHHHH AFTER" + scanCoordinates.size());
        if(scanType == "mag"){
